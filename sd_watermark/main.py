...
def get_parser(**parser_kwargs):
    ...
    # -------- for normal training, required=True. -------- #
...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, clamp=True, increase_log_steps=True,
                 ...
                 log_images_kwargs=None, log_images_dir=None):
        super().__init__()
    ...
    def check_frequency(self, check_idx):
        if ((check_idx % self.batch_freq) == 0 or (check_idx in self.log_steps)) or check_idx == 1:
...
if __name__ == "__main__":
    ...
    try:
        ...
        # w_reg_weights
        model.w_reg_weight = opt.w_reg_weight
        ...
        trainer_kwargs["max_steps"] = trainer_opt.max_steps + 5  # to prevent (99->100)


        # --------------------------------- INIT Wandb logger --------------------------------- #
        wandb_logger = WandbLogger(project=opt.wandb_project_name, name=opt.wandb_run_name)
        ...
        if opt.scale_lr:
            ...
            print("++++ NOT USING LR SCALING ++++")  # yunqing: we use this
            print(f"Setting learning rate to {model.learning_rate:.2e}")  # 1e-6
