...
def main():
    ...
    parser.add_argument(
        ...
        default="../_outputs/txt2img-samples"
    )
    parser.add_argument(
        "--skip_grid",
        action='store_true',
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="rows in the grid (default: n_rows)",
    )
    parser.add_argument(
        "--scale",
        type=float,
    ...
    if opt.laion400m:
        ...
        opt.outdir = "../_outputs/txt2img-samples-laion400m"
    ...
    with torch.no_grad():
        with precision_scope("cuda"):
            with model.ema_scope():
                ...
                for n in trange(opt.n_samples//opt.batch_size, desc="Sampling"):
